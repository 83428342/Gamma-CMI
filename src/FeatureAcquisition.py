...
class FeatureAcquisition():
    def __init__(self, x, m, generative_model, num_samples, predictor, alpha=1, gamma=0, num_gamma_samples=1):
        self.x = x
        self.m = m
        ...
        self.alpha = alpha
        self.gamma = gamma
        self.num_gamma_samples = num_gamma_samples
