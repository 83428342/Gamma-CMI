...
torch.save(best_teacher_state, os.path.join(save_dir, "teacher_fashion_mnist.pt"))
torch.save(best_student_state, os.path.join(save_dir, "student_fashion_mnist.pt"))
