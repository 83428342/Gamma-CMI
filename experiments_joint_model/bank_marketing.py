...
torch.save(best_teacher_state, os.path.join(save_dir, "teacher_bank_marketing.pt"))
torch.save(best_student_state, os.path.join(save_dir, "student_bank_marketing.pt"))
